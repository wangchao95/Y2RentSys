		...
		<form method="post"  id='sform'>
			<dt>
				<ul>
					...
					<li>
						标题：<input type="text" class="text" value='<s:property value="title"/>' name="house.title" />
						<label class="ui-blue"><input type="button" id="search" name="search" value="搜索房屋" /></label>
					</li>
				</ul>
			</dt>
			<dd>
			...
			<dd>
				<ul>
					...
					<li>
							<select name='house.street.id' id='street'>
			...
			<dd>
				<ul>
					...
					<li>
							<select name='house.type.id' id="type">
								<option value='0'>不限</option>
							</select>
					</li>
				</ul>
...
<div class="main wrap">
	<table class="house-list"  id="tableInfo">
	...
	<div class="page">
		<%--<ul>--%>
			...
			<%--&lt;%&ndash; <a href='/HouseRent/index.action?number=<s:property value="prev"/>'>上一页</a> &ndash;%&gt;</li>--%>
			<%--<li>--%>
			<%--<s:url id="nex" value="index.action">--%>
				<%--<s:param name="number" value="next"></s:param>--%>
			<%--</s:url>--%>
			<%--<s:a href="%{nex}">下一页</s:a>--%>
			<%--&lt;%&ndash; <a href='/HouseRent/index.action?number=<s:property value="next"/>'>下一页</a> &ndash;%&gt;</li>--%>
			<%--<li>--%>
			<%--<s:url id="last" value="index.action">--%>
				<%--<s:param name="number" value="total"></s:param>--%>
			<%--</s:url>--%>
			<%--<s:a href="%{last}">末页</s:a>--%>
			<%--&lt;%&ndash; <a href='/HouseRent/index.action?number=<s:property value="total"/>'>末页</a> &ndash;%&gt;</li>--%>
		<%--</ul>--%>
...
<script src="${path}/scripts/jquery-form.js"></script>
<script src="${path}/scripts/Street.js"></script>
<script src="${path}/scripts/Type.js"></script>
<script src="${path}/scripts/house_list.js"></script>